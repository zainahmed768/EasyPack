    ...
    <div class="conainer-fluid mx-0">
        <div class="row mx-0">
            <div class="col-xl-6 col-lg-6 col-md-6 pl-0">
                <div class="main_img">
                    <img src="images/auth_logo.png" class="img-fluid" alt="">
                </div>
            </div>
                                ...
                                <div class="form_start mt-5">
                                    <form action="">
                                        ...
                                        <div class="form_row mt-3">
                                            ...
                                            <div class="single_input">
                                                <input type="email" name="" id="" placeholder="Confirm Password">
                                            </div>
                                        </div>
                                        <div class="form_row mt-3">
                                            <button class="btn center d-block w-100" type="submit">Register</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<!-- Head include --><?php include('inc/head.php'); ?>
